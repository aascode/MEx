...
results_file = 'dot_act_acw_dc.csv'
...
def build_mid_fusion():
    ...
    c = concatenate([x, y, z])
    xy = DotAttentionLayer(1200)([x, y])
    xz = DotAttentionLayer(1200)([x, z])
    yz = DotAttentionLayer(1200)([y, z])
    c = concatenate([c, xy, xz, yz])
...
def build_late_fusion():
    ...
    c = concatenate([x, y, z])
    xy = DotAttentionLayer(100)([x, y])
    xz = DotAttentionLayer(100)([x, z])
    yz = DotAttentionLayer(100)([y, z])
    c = concatenate([c, xy, xz, yz])
