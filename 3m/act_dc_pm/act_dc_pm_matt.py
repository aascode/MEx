...
def build_early_fusion():
    ...
    input_tdcpm = EarlyAttentionLayer(feature_length+(dc_frames_per_second*dc_frame_size)+(pm_frames_per_second*pm_frame_size))([input_t, input_dc, input_pm])
...
def _run_(act_train_features, dc_train_features, pm_train_features, train_labels, act_test_features, dc_test_features,
    ...
    results = 'act_dc_pm' + ',' + str(fusion)+',' + str(accuracy)+',' + str(f_score)
    print(results)
