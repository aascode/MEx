...
results_file = '/home/mex/results/np_dc_0.05.csv'
...
def build_model_2D():
    ...
    #print(model.summary())
    write_data(results_file, str(model.summary()))
    return model
...
def run_model_2D(_train_features, _train_labels, _test_features, _test_labels):
    ...
    _model.fit(_train_features, _train_labels, verbose=0, batch_size=32, epochs=15, shuffle=True)
