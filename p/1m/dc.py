...
path = '/home/mex/data/0.05/'
results_file = '/home/mex/results/p_dc_0.05.csv'
...
def run_model_2D(_train_features, _train_labels, _test_features, _test_labels):
    ...
    _model.fit(_train_features, _train_labels, verbose=1, batch_size=32, epochs=15, shuffle=True)
...
def run():
    ...
    for i in range(len(test_user_fold)):
        ...
        run_model_2D(train_features, train_labels, test_features, test_labels)
