...
from keras.layers import Input, Dense, BatchNormalization, Conv1D, MaxPooling1D, LSTM, TimeDistributed, Reshape, Flatten
...
path = '/Volumes/1708903/MEx/Data/actmin/'
results_file = 'act_att.csv'
...
def _run_(_train_features, _train_labels, _test_features, _test_labels):
    ...
    results = 'act,' + str(i)+',' + str(accuracy)+',' + str(f_score)
    print(results)
