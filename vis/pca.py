...
'''
s_pca = PCA(n_components=3)
s_pca_features = s_pca.fit_transform(s_features)
...
ax.scatter(s_pca_features[:, 0], s_pca_features[:, 1], s_pca_features[:, 2], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
'''
