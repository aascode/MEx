...
def read():
    ...
    subjects = os.listdir(path)# ['24', '23', '22', '25', '26']#['17', '16', '18', '20', '29'] #
...
#s_pca = _pca.fit_transform(s_features)
#print('1:'+str(sum(_pca.explained_variance_ratio_.tolist())))
#s_pca_features = TSNE(n_components=2).fit_transform(s_pca)
#plt.scatter(s_pca_features[:, 0], s_pca_features[:, 1], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
#plt.legend()
#plt.show()
#_pca = PCA(n_components=2)
#s_pca = _pca.fit_transform(s_features)
#print('2:'+str(sum(_pca.explained_variance_ratio_)))
#s_pca_features = TSNE(n_components=2).fit_transform(s_pca)
#plt.scatter(s_pca_features[:, 0], s_pca_features[:, 1], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
#plt.legend()
#plt.show()
...
#s_pca = _pca.fit_transform(s_features)
#print('5:'+str(sum(_pca.explained_variance_ratio_)))
#s_pca_features = TSNE(n_components=2).fit_transform(s_pca)
#plt.scatter(s_pca_features[:, 0], s_pca_features[:, 1], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
#plt.legend()
#plt.show()
...
#s_pca = _pca.fit_transform(s_features)
#print('10:'+str(sum(_pca.explained_variance_ratio_)))
#s_pca_features = TSNE(n_components=2).fit_transform(s_pca)
#plt.scatter(s_pca_features[:, 0], s_pca_features[:, 1], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
#plt.legend()
#plt.show()
#_pca = PCA(n_components=25)
#s_pca = _pca.fit_transform(s_features)
#print('25:'+str(sum(_pca.explained_variance_ratio_)))
#s_pca_features = TSNE(n_components=2).fit_transform(s_pca)
#plt.scatter(s_pca_features[:, 0], s_pca_features[:, 1], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
#plt.legend()
#plt.show()
...
#s_pca = _pca.fit_transform(s_features)
#print('50:'+str(sum(_pca.explained_variance_ratio_)))
#s_pca_features = TSNE(n_components=2).fit_transform(s_pca)
#plt.scatter(s_pca_features[:, 0], s_pca_features[:, 1], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
#plt.legend()
#plt.show()
...
#s_pca = _pca.fit_transform(s_features)
#print('100:'+str(sum(_pca.explained_variance_ratio_)))
#s_pca_features = TSNE(n_components=2).fit_transform(s_pca)
#plt.scatter(s_pca_features[:, 0], s_pca_features[:, 1], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
#plt.legend()
#plt.show()

_pca = PCA(n_components=200)
s_pca = _pca.fit_transform(s_features)
print('200:'+str(sum(_pca.explained_variance_ratio_)))
s_pca_features = TSNE(n_components=2).fit_transform(s_pca)
plt.scatter(s_pca_features[:, 0], s_pca_features[:, 1], c=labels, edgecolor='none', alpha=0.8, cmap=plt.cm.get_cmap('spectral', 7))
plt.legend()
plt.show()
#s_pca_features = TSNE(n_components=2).fit_transform(s_features)
