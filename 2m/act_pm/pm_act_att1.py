...
def build_early_fusion():
    ...
    input_tpm = concatenate([input_t, input_pm], axis=2)
    z = Reshape((window, feature_length+(pm_frames_per_second*pm_frame_size)))(input_tpm)
    ...
    z = Reshape((window, feature_length+(pm_frames_per_second*pm_frame_size), 1))(z)
