...
results_file = '/home/mex/results_lopo/2m/dotatt_acw_act.csv'
...
def _run_(_train_features, _train_labels, _test_features, _test_labels):
    ...
    model.fit([_train_features_t, _train_features_w], _train_labels, verbose=1, batch_size=32, epochs=30, shuffle=True)
