...
results_file = 'dotatt_dc_acw.csv'
...
class DotAttentionLayer(Layer):
    ...
    def build(self, input_shape):
        super(DotAttentionLayer, self).build(input_shape)

    def call(self, inputs):
        input1 = inputs[0]
        print(K.int_shape(input1))
        input1 = tf.expand_dims(input1, 1)
        print(K.int_shape(input1))
        input2 = inputs[1]
        print(K.int_shape(input2))
        input2 = tf.expand_dims(input2, 1)
        print(K.int_shape(input2))

        z = K.batch_dot(input1, input2, axes=[1, 1])
        print(K.int_shape(z))
