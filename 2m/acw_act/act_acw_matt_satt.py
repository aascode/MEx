...
from keras.layers import Layer, Input, Dense, BatchNormalization, Conv1D, MaxPooling1D, LSTM, TimeDistributed, Reshape, Add, Dot, concatenate, Multiply
...
# fusion by correct bahdanau attention for DCT ACW and ACT data
...
def build_early_fusion():
    ...
    input_tw = EarlyAttentionLayer(feature_length+feature_length)([input_t, input_w])
