...
def build_mid_fusion():
    ...
    y = Dense(1080, activation='relu')(y)
    y = BatchNormalization()(y)
    y = Dense(720, activation='relu')(y)
    y = BatchNormalization()(y)
    y = SensorAttentionLayer(720)(y)

    z = concatenate([x, y])
    z = Dense(1080, activation='relu')(z)
    z = BatchNormalization()(z)
    z = Dense(540, activation='relu')(z)
    z = BatchNormalization()(z)
    z = Dense(240, activation='relu')(z)
    z = BatchNormalization()(z)
    z = SensorAttentionLayer(240)(z)
...
def _run_(act_train_features, dc_train_features, train_labels, act_test_features, dc_test_features, test_labels):
    ...
    results = 'act_dc' + ',' + str(accuracy)+',' + str(f_score)
    print(results)
