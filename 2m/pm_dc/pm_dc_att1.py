...
from keras.layers import Input, Dense, BatchNormalization, Conv1D, MaxPooling1D, LSTM, TimeDistributed, Reshape, Multiply, concatenate, Conv2D, MaxPooling2D, Flatten
...
def build_early_fusion():
    ...
    z = Reshape((window, (frames_per_second*dc_frame_size)+(frames_per_second*pm_frame_size)))(input_pmdc)
    ...
    z = Reshape((window, (frames_per_second*dc_frame_size)+(frames_per_second*pm_frame_size), 1))(z)
