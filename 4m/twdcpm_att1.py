...
def build_mid_fusion():
    ...
    score = Dense(1200, activation='tanh')(c)
    attention_probs = Dense(4800, activation='softmax', name='attention_vec')(score)
...
def build_late_fusion():
    ...
    attention_probs = Dense(400, activation='softmax', name='attention_vec')(score)
    c = Multiply()([c, attention_probs])
