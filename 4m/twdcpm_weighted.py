...
results_file = 'act_acw_dc_pm_weighted.csv'
...
def build_mid_fusion():
    ...
    con = concatenate([x, y, z, w])
    wei = WeightedLayer(4800)([x, y, z, w])

    c = concatenate([con, wei])
...
def _run_(act_train_features, dc_train_features, pm_train_features, acw_train_features, train_labels,
    ...
    results = 'act_acw_dc_pm' + ',' + str(fusion)+',' + str(accuracy)+',' + str(f_score)
    print(results)
